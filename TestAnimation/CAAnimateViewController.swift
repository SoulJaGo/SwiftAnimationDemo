...
//        self.newKeyFrameAnimate()
    ...
    //MARK: 动画方法部分
    func caBasicAnimate() {
        var imgView = UIImageView(image: UIImage(named: "maiziLogo")!)
        ...
        var opacityAni = CABasicAnimation(keyPath: "opacity")
    ...
    func keyFrameAnimate() {
        ...
        var keyAni = CAKeyframeAnimation(keyPath: "position")
        //values
        var value0 = NSValue(CGPoint: la.frame.origin)
        var value1 = NSValue(CGPoint: CGPointMake(la.frame.origin.x, la.frame.origin.y + 100))
        var value2 = NSValue(CGPoint: CGPointMake(la.frame.origin.x - 150, la.frame.origin.y + 100))
        var value3 = NSValue(CGPoint: CGPointMake(la.frame.origin.x - 150, la.frame.origin.y))
        var value4 = NSValue(CGPoint: la.frame.origin)
...
//        keyAni.timingFunctions = [timingFunction, timingFunction, timingFunction, timingFunction, timingFunction]
        ...
        var scaleAni = CABasicAnimation(keyPath: "transform.scale.y")
        scaleAni.fromValue = 1.0
